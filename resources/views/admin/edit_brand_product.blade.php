@extends('admin_layout')
 ...
 <div class="form-group">
    ...
    <div class="form-group">
    <label for="exampleInputPassword1">Mô tảdanh mục</label><br>
    <textarea style="resize: none;width: 100%;"rows="8" class="form- control" name="brand_product_desc" id="exampleInputPassword1" >{{$edit_value->brand_desc}}</textarea>
    </div>
    <div class="form-group">
